...
class BaiduImage():
    ...
    def __init__(self, keyword, count=540, save_path="img", rn=60):
        ...
        self.__acJsonCount = int(self.__get_ac_json_count())
...
if __name__ == '__main__':
    search = BaiduImage("吴彦祖", save_path=r"D:\PycharmProjects\myface\DanielWu_IMAGES")
    search.search()